...
describe(`enumeratePatterns`, () => {
  it(`should enumerate`, () => {
    expect(enumeratePatterns(ROOT)(log)(patternsMap())).to.eql(expected());
  });
  it(`should not error on a file path that is a glob, that expands to nothing`, () => {
    const absoluteRoot = '/Users/tre/development/projects/kibana';
    expect(enumeratePatterns(absoluteRoot)(log)(new Map([
      [
...
function expected () {
  return ['src/dev/code_coverage/ingest_coverage/constants.js kibana-qa',
